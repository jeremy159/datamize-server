...
pub async fn balance_sheet_resource<FRS: FinResServiceExt>(
...
pub async fn update_balance_sheet_resource<FRS: FinResServiceExt>(
    Path(resource_id): Path<Uuid>,
    State(fin_res_service): State<FRS>,
...
#[tracing::instrument(skip_all)]
pub async fn delete_balance_sheet_resource<FRS: FinResServiceExt>(
    Path(resource_id): Path<Uuid>,
    State(fin_res_service): State<FRS>,
) -> HttpJsonDatamizeResult<FinancialResourceYearly> {
